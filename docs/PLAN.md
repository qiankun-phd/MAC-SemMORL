...
2. **Constrained MORL is the new SOTA** (C-MORL ICLR 2025, PSL-MORL 2025). Soft preference alone is conference-level; hard constraints + Lagrangian/dual methods are journal-level.
